...
import Persistence.VitoriasCampDAO;
 ...
 * @author Gabruel
 */
public class PesquisaVitoriasCamp extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            VitoriasCampDAO dao = new VitoriasCampDAO();
            maxRows = dao.qtdRows(esporte, tipo);
            nPag = ( maxRows + 9 ) / 10;
            List<VitoriasCamp> lista;
            ...
            dispatcher = request.getRequestDispatcher("/viewPesquisaCamp.jsp");
