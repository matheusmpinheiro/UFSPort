...
<%@page import="Model.VitoriasPais"%>
        ...
        <div class="bg-content">
            <div class="container">
                ...
                <div id="campos-pesquisa">
                            <h2><b>Vitórias por país</b></h2>

                            <p>Pesquise pelos times que tiveram mais vitórias em cada país do mundo. Busque entre os mais vitoriosos
                            ou os menos vitoriosos. Se desejar pode também selecionar um esporte da lista.</p>

                                <form id="contact-form" method="post" action="PesquisaVitoriasPais">
                                    <fieldset>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td><select name="esporte" id="esportes">
                                               ...
                                               <!-- <input type="text" name="esporte" value="">-->
                                        </tr>
                                        <tr>
                                            <td>Tipo</td> 
                                            <td><select name="tipo">
                ...
                <div class="tabela">
                    <form id="idTabela" method="Post" action="PesquisaVitoriasPais">
                        <%
                            List<VitoriasPais> vitorias = (List<VitoriasPais>)request.getAttribute("lista");
                            if(vitorias.isEmpty()){
                                %><h5>Ooops... :'(</h5>
